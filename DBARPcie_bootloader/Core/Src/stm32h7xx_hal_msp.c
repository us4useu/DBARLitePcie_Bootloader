...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PD2     ------> TIM3_ETR
    */
    HAL_GPIO_DeInit(HV_SYNC_GPIO_Port, HV_SYNC_Pin);

    HAL_GPIO_DeInit(GCLK_TIM3_GPIO_Port, GCLK_TIM3_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PH10     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(GPIOA, GCLK_TIM5_Pin|DC3V3_SYNC_Pin);

    HAL_GPIO_DeInit(DC12V_SYNC_GPIO_Port, DC12V_SYNC_Pin);
