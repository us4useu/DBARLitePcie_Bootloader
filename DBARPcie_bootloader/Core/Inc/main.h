...
#define ARRIUS_1_PMBUS_CNTRL_N_Pin GPIO_PIN_3
#define ARRIUS_1_PMBUS_CNTRL_N_GPIO_Port GPIOE
#define ARRIUS_0_PMBUS_CNTRL_N_Pin GPIO_PIN_8
#define ARRIUS_0_PMBUS_CNTRL_N_GPIO_Port GPIOB
...
#define SFF_0_PERST_EXTI_IRQn EXTI15_10_IRQn
...
#define SFF_1_PERST_EXTI_IRQn EXTI15_10_IRQn
